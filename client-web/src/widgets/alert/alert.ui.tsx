...
const Alert = (props: props): ReactElement => {
  return (
    ...
    >
      <div
        className="w-[30rem] min-h-[10rem] flex flex-col justify-center p-8 rounded-2xl bg-white z-[8100] border-none"
      ...
      >
        ...
        <div className="w-full flex flex-col justify-center items-center gap-4 mt-8">
          <button
            className="w-full rounded-[20px] py-4 px-8 cursor-pointer border-none bg-secondary-500"
            onClick={props.onClick}
          >
