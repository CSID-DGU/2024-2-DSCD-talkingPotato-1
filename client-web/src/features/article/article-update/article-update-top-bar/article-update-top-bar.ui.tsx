...
export const ArticleUpdateTopBar = (): ReactElement => {
    ...
    return (
        <Styled.Column>
            <Styled.Container>
                <Styled.Row>
                    <HeadExtra text={"칼럼 수정하기"} textAlign={"start"}/>
...
export default ArticleUpdateTopBar;