...
import * as Styled from "./update-content-input.style.ts";
...
export const UpdateContentInput = (props: props): ReactElement => {

    return (
        <Styled.Container>
            <Styled.LabelWithLine>
                <Sub2 text={"내용"} color={theme.colorSystem.primary["500"]} whiteSpace={"nowrap"}/>
                <SizedBox width={"12px"}/>
                <SizedBox height={"1px"} width={"100%"} background={theme.colorSystem.primary["500"]}/>
            </Styled.LabelWithLine>
            <SizedBox height={"20px"}/>
            <MarkdownEditor markdownValue={props.markdownValue} setMarkdownValue={props.setMarkdownValue}/>
        </Styled.Container>
    )
}
