...
class ArticleResultView extends BaseWidget<ArticleSearchingViewModel> {
  const ArticleResultView({super.key});
      ...
      if (viewModel.mode == 'searching') {
        return Row(
          ...
          children: [
            ...
            GestureDetector(
              onTap: viewModel.clearRecentSearchTermList,
              child: Text(
                "전체 삭제",
            ...
            return Padding(
              ...
              child: Row(
                children: [
                  ...
                  GestureDetector(
                    onTap: () {
                      viewModel.removeRecentSearchTerm(index);
                    },
                    child: Icon(
                      Icons.close,
                      size: 24,
